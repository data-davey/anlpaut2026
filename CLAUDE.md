# ANLP AUT 2026 — Claude Code Instructions
...
Each session has its own **folder** and its own **git branch**. All work for a session must be done in the corresponding branch and folder.

| Session | Date | Branch | Folder | Topics |
|---------|------|--------|--------|--------|
| Session 6 | 23 Mar 2026 | `session-6` | `session-6-transformers/` | Transformers, BERT, Language Models, LLM intro, Generative AI tools |
| Session 7 | 30 Mar 2026 | `session-7` | `session-7-llm-deep-dive/` | LLM deep dive, prompting, LLM challenges & risks, LLM evaluation |
| Session 8 | 13 Apr 2026 | `session-8` | `session-8-llm-apps/` | Building LLM apps with OpenAI, Claude & Ollama APIs, RAG pattern |
| Session 9 | 20 Apr 2026 | `session-9` | `session-9-ai-agents/` | AI Agents, multi-agent frameworks, hands-on exercises |
| Session 10 | TBD | `session-10` | `session-10-ethics/` | Ethics in NLP, NLP for social good, AI-augmented thinking, AI security (guest speaker) |
